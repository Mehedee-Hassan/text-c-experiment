...
class LocationChunker(ChunkParserI):
    ...
    __current_path = os.path.dirname(os.path.realpath(sys.argv[0]))
    projectpath = os.path.dirname(os.path.realpath('gazetteer.py'))

    def readGazetteers_list(self):



        file_opener = open(self.projectpath+'\\sentence_with_loc\\gazetteers_list','r')
